...
<?php if (isset($_SESSION['username'])) header("location:profile/index.php"); ?> 
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width,initial-scale=1 shrink-to-fit=no">
	<title>Instruo Signup & Login</title>
           	...
           	<div class="card">
				...
				<div class="card-body">
					<form id="login-submit-form">
						...
						<div class="form-group">
							<input type="email" name="login_email" id="login-email" class="form-control" placeholder="Enter Email Or Username...">
